...
func handleFormSubmit() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_handleFormSubmit_5f2e`,
		Function: `function __templ_handleFormSubmit_5f2e(){document.addEventListener("DOMContentLoaded", function () {
       ...
       loginForm.addEventListener("submit", handleSubmit);
		...
		Call:       templ.SafeScript(`__templ_handleFormSubmit_5f2e`),
		CallInline: templ.SafeScriptInline(`__templ_handleFormSubmit_5f2e`),
	}
}
